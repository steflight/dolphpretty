                ...
                <form role="form" method="post" class="validate" enctype="multipart/form-data">
                    ...
                    <div class="form-group ">
                        ...
                        <select id="selectError" class="col-md-3" data-rel="chosen" name="shop_id">
							...
							$s = ($shop->id == $data->shop_id) ? "selected" : "";
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" name="offers" class="form-control required" placeholder="Enter Offer" value="<?php echo $data->offers; ?>">
                    </div>
                    
                   
                    
                    <button type="submit" class="btn btn-custom"><i class="glyphicon glyphicon-plus"></i> Update Offers</button>
                </form>
