...
<div class="row">
    ...
    <tr>
        ...
        <td class="center">
            ...
            <a class="btn btn-info btn-sm" href="<?php echo base_url(); ?>slider/edit_slider/<?php echo $slider->id; ?>">
                <i class="glyphicon glyphicon-edit icon-white"></i>
                Edit
            </a>
            
            <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>slider/delete_slider/<?php echo $slider->id; ?>">
